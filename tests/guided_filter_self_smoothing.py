...
print("""
Guided Filter Self Smoothing.
An Image is used as filtering guide to smooth itself preserving edges.
""")
...
lr_rgb_tf_guided_filtered = GF(lr_rgb_tf, lr_rgb_tf_guided_filtered) #guiding image, guided image
lr_rgb_tf_guided_filtered = GF(lr_rgb_tf, lr_rgb_tf_guided_filtered) #guiding image, guided image
